...
sudo -u postgres psql -c "CREATE USER glamiq_user WITH ENCRYPTED PASSWORD 'GlamIQSecurePass2026!';"
...
DATABASE_URL=postgresql+asyncpg://glamiq_user:GlamIQSecurePass2026!@localhost:5432/glamiq
DATABASE_SCHEMA=glamiq
JWT_SECRET=glamiq-production-secret-vps-2026
JWT_ALGORITHM=HS256
ACCESS_TOKEN_EXPIRE_MINUTES=60
REFRESH_TOKEN_EXPIRE_DAYS=7
CORS_ORIGINS=http://156.67.30.190,http://localhost:3000
OPENAI_API_KEY=
NVIDIA_API_KEY=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
